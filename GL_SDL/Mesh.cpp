...
struct Mesh {
    ...
    void setup(int numVerts, v3 *verts, v3 *norms, v3 *colors, int numInds, ushort *indices) {
...
//        }
        ...
        glBufferData(GL_ARRAY_BUFFER, numVertices * sizeof(v3), colors, GL_STATIC_DRAW);
